...
| Domain | Technologies |
|--------|-------------|
| **Mobile Development** | Kotlin, Jetpack Compose, MVVM Architecture, Room, Background Services |
| **Backend & Full-Stack** | Python, FastAPI, Node.js, Next.js, Prisma, Redis |
| **AI & Computer Vision** | YOLOv8, MediaPipe FaceMesh, CLIP ViT-L/14, PyTorch, 3D Noise2Void |
| **Programming Languages** | Python, Kotlin, JavaScript/TypeScript, C++ |
| **Tools & Infrastructure** | Git, Docker, MongoDB, PostgreSQL, Firebase |
...
*   📊 **CGPA: 8.81** — Rajasthan Technical University, B.Tech CSE